...
def run_model(model_name, dataset_name, test_size=0.1, clean=False):
    print('*' * 70)
...
if __name__ == '__main__':
    ...
    test_size = 0.1
    # model_type dataset_name test_size clean
    run_model(model_type, dataset_name, test_size=test_size, clean=True)
    main_time.finish()
